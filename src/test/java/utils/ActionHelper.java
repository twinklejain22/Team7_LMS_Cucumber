...
public class ActionHelper {
	...
	public boolean isDataTableSortedDescending() {
		return false;

	}

	public boolean isDataTableSortedAscending() {
		return false;
	}
...
//Implement logic to extract data from the data table and check if it's sorted in descending order.
// You'll need to interact with the dataTable WebElement and perform your validation here.
