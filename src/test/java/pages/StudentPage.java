...
//	@FindBy(xpath="//")
	...
	@FindBy(xpath = "//select[@name='student']")
	WebElement studentDropdownSelect;
	...
	WebElement batchIdDropdownSelect;

	@FindBy(xpath = "//div[@name='studentDetails']")
	WebElement studentsResult;
...
//	
	...
	public void validateStudentScrolldown() {
		...
		Assert.assertTrue(studentDropdownSelect.isDisplayed());

//    	JavascriptExecutor je = (JavascriptExecutor) driver;
//    	//Identify the WebElement which will appear after scrolling down
//
//    	WebElement element = driver.findElement(By.xpath(".//*[@id='studentNameDropdown']/p[3]"));
//
...
//    	je.executeScript("arguments[0].scrollIntoView(true);",element);
	...
	public void validateBatchIdScrolldown() {
		...
		Assert.assertTrue(batchIdDropdownSelect.isDisplayed());
	...
	// @testcase-21
	public void detailsNotDisplayed() {
		Assert.assertFalse(studentsResult.isDisplayed());
	}

	// @testcase-23
	public void detailsDisplayed() {
		Assert.assertTrue(studentsResult.isDisplayed());
	}
	...
	public void isAdminPage() {
		actionHelper.IsPageOpen(
				FileReaderManager.getInstance().getConfigReader().getAdminURL()
				);
